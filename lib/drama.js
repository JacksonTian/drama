/*global EventProxy, _, Land, Landscape, enableGestureEvents*/
!(function () {
  // 全局对象
  var root = this;
  ...
  drama.showSidebar = function (callback) {
    ...
    stage.anim({translate3d: (width - 60) + "px, 0, 0"}, 0.3, 'ease-in-out', callback);
  };

  drama.hideSidebar = function (callback) {
    var stage = $("#stage");
    stage.anim({translate3d: "0, 0, 0"}, 0.3, 'ease-in-out', callback);
  };
