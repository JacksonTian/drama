/*global EventProxy, _, Land, Landscape*/
!(function () {
  // 全局对象
  var root = this;
  ...
  drama.switchAct = function (next, callback) {
    var previous = drama.currentCard;
  ...
  drama.setOrientation = function () {
    ...
    var _setOrientation = function () {
      ...
      // TODO: trigger the orientation event to current stage
  ...
  drama.showSidebar = function () {
    var stage = $("#stage");
    var width = window.innerWidth;
    stage.anim({translate3d: (width - 60) + "px, 0, 0"}, 0.3, 'ease-in-out');
  };

  drama.hideSidebar = function () {
    var stage = $("#stage");
    stage.anim({translate3d: "0, 0, 0"}, 0.3, 'ease-in-out');
  };
